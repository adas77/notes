    ...
    return (
        <>
            ...
            <form onSubmit={e => handleSubmit(e)}>
                <div className="mb-6">
                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email (min 6 length i typu email)</label>
                ...
                <div className="mb-6">
                    <label htmlFor="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your <b>Username (min 6 length unikalne)</b></label>
                ...
                <div className="mb-6">
                    <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your <b>Password (min 8 legnth)</b></label>
